    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerQn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(signup_player.this, login_player.class);
                    ...
                    mAuth.createUserWithEmailAndPassword(emailString, passwordString).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (!task.isSuccessful()){
                                ...
                                Toast.makeText(signup_player.this, "Error" + error, Toast.LENGTH_SHORT).show();
                            }
                            else {
                                String currentUserId = mAuth.getCurrentUser().getUid();
                                userDatabaseRef = FirebaseDatabase.getInstance().getReference()
                                        .child("players").child(currentUserId);
                                ...
                                userDatabaseRef.updateChildren(userInfo).addOnCompleteListener(new OnCompleteListener() {
                                    ...
                                    public void onComplete(@NonNull Task task) {
                                        if (task.isSuccessful()){
                                            Toast.makeText(signup_player.this, "Data set Successfully", Toast.LENGTH_SHORT).show();
                                        }else {
                                            Toast.makeText(signup_player.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                        }
                                ...
                                Intent intent = new Intent(signup_player.this, MainActivity.class);
                                startActivity(intent);
                                finish();
                                loader.dismiss();
